...
async def cara_order(call: types.CallbackQuery):
    ...
    await call.message.edit_text(text, parse_mode="Markdown", reply_markup=types.InlineKeyboardMarkup(
...
async def back_to_menu(call: types.CallbackQuery):
    ...
    await call.message.edit_text("👋 Selamat datang di Store Bot!\n\nSilakan pilih menu di bawah ini untuk melihat produk dan cara order.", reply_markup=keyboard)
